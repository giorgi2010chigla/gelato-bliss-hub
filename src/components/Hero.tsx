...
import heroImage from "@/assets/sakhli-1904-interior.jpg";
...
const Hero = () => (
  <section id="home" className="relative min-h-[92vh] flex items-center overflow-hidden">
    <div className="absolute inset-0">
      <img
        src={heroImage}
        alt="Cozy Georgian restaurant interior with antique portraits, rugs, and wooden tables"
    ...
    <div className="relative z-10 container mx-auto px-6 pt-24">
      <div className="max-w-2xl">
        ...
        >
          <Star size={16} className="fill-accent text-accent" /> 4.8 rated Georgian restaurant
        </motion.div>
        <motion.h1
        ...
        >
          Authentic Georgian cuisine, antique-house atmosphere, homemade wine, and warm hospitality in the heart of Tbilisi.
        </motion.p>
        <motion.div
